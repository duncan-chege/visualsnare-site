...
<body <?php body_class(); ?>>
    <header>
        <nav class="mx-2 z-10 bg-white/80 backdrop-blur-md border-light-blue border-2 rounded-2xl lg:w-2/5 md:w-3/4 w-auto justify-between my-0 md:mx-auto fixed top-2 left-0 right-0 flex flex-row py-2 px-4 md:px-16 bg-light-grey transition-transform duration-300" id="navbar">
            <a href="<?php echo home_url('/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/main-logo.svg" class="w-full h-[30px]" alt="main website logo"></a>
