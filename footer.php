...
<footer class='bg-light-grey text-grey grid md:grid-cols-2 grid-cols-1 gap-6 p-8 md:p-0'>
    ...
    <div>
        <h2 class="text-4xl font-bold text-orange pt-10 pb-4">Let’s Connect and Create Something Extraordinary.</h2>
        <p class="text-lg">We are also open to collaborate with other designers/developers</p>
